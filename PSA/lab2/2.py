...
print(f"The guy was right in {was_right_for_num_samp_1} cases out of 100")

was_right_for_num_samp_2 = run_the_thing(NUM_SAMPLES_2, 0.48, 0.52)
print(f"The guy was right in {was_right_for_num_samp_2} cases out of 100")

was_right_for_diff_dist = run_the_thing(NUM_SAMPLES_2, 0.49, 0.51)
print(f"The guy was right in {was_right_for_diff_dist} cases out of 100")
