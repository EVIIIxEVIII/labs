...
thePassword = input("Please input the password > ")
steps = passwordChecker.strongPasswordChecker(thePassword)
print("The password is good") if steps == "good" else print(f"You would have to make {steps} to fix it")
